...
server.listen(3000, () => {
  ...
  console.log(`my server is running at http://${getIpv4()}:3000/api/news`)
  console.log(`my server is running at http://${getIpv4()}:3000/api/students`)
})
